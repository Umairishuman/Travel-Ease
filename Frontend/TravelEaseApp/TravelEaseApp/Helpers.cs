...
namespace TravelEaseApp
{
    ...
    {
        public static string connectionString = "Data Source=BLAZ\\SQLEXPRESS;Initial Catalog=ViewsBackupV2;Integrated Security=True;Trust Server Certificate=True";
