...
namespace TravelEaseApp
{
    ...
    {
        public static string connectionString = "Data Source=DESKTOP-ON2MGLP\\SQLEXPRESS;Initial Catalog=latestbacpac;Integrated Security=True;TrustServerCertificate=True";
